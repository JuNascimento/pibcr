...
class MinistriesContainer extends Component {
  render() {
    return (
      <PageContainerLight>
        <PageTitle>
          <PageTitleLabelLight>Ministérios</PageTitleLabelLight>
        </PageTitle>
        <Subtitle>
          <SubtitleText>
            ...
            <Emphasis>entre outros</Emphasis>. Cada ministério tem uma direção a
            seguir (área de ação).
            <MinistriesDuty>
        ...
        <MinistriesDescription>
            ...
            <MinistryInfo>
              ...
              <MinistryDescription>
                <MinistryDescriptionText left={true}>
                  É um ministério voltado para a faixa etária acima dos 60 anos,
                  ele existe para acompanhar e aproximar os idosos de nossa
                  Igreja e da comunidade, dedicando-lhes atenção e buscando um
                  contato mais próximo: físico, espiritual e emocional, através
                  de estudos, visitas, atividades e passeios que realizamos no
                  decorrer do ano.
                </MinistryDescriptionText>
              </MinistryDescription>
            </MinistryInfo>
            ...
            <MinistryInfo>
              <MinistryDescription>
                <MinistryDescriptionText left={false}>
                  ...
                  famílias e ser um canal onde as famílias possam ser edificadas
                  e tratadas. Temos como objetivo trabalhar com a valorização
                  dos relacionamentos entre casais, com a orientação antes do
                  casamento para noivos e namorados, educação dos pais, entre
                  outras atividades.
                </MinistryDescriptionText>
              </MinistryDescription>
          ...
          <Ministry>
            <MinistryName>Ministério do Esporte</MinistryName>
            <MinistryInfo>
              <MinistryLogo src="images/ministerio-esporte.png" />
              <MinistryDescription>
                <MinistryDescriptionText left={true}>
                  O ministério de esporte existe para alcançar pessoas de todas
                  as idades para Cristo, usando a linguagem esportiva como
                  atrativo e ponte entre a comunidade e a Igreja. Dessa forma,
                  as pessoas praticam uma atividade esportiva, de acordo com sua
                  identificação com um esporte que, além de ser importante para
                  a saúde, é uma oportunidade singular de serem edificados na
                  Palavra de Deus, integrados ao serviço no Corpo de Cristo e
                  comissionados a ganhar outros para Jesus, cumprindo a Grande
                  Comissão.
                </MinistryDescriptionText>
              </MinistryDescription>
            </MinistryInfo>
          ...
          <Ministry>
            ...
            <MinistryInfo>
              ...
              <MinistryDescription>
                <MinistryDescriptionText left={true}>
                  Existe para promover a integração entre os membros da Igreja.
                  Visa a comunhão da família de Deus, levando os membros a
                  práticas de relacionamentos espirituais, sociais e solidários.
                  Principais atribuições: desenvolver planejamentos de programas
                  especiais em datas comemorativas e eventos, tais como:
                  organizar atividades recreativas como piqueniques, passeios e
                  retiros no sítio, festa de confraternização, café da manhã,
                  almoço e encontro com lideranças.
                </MinistryDescriptionText>
              </MinistryDescription>
            </MinistryInfo>
          </Ministry>
            ...
            <MinistryInfo>
              ...
              <MinistryDescription>
                <MinistryDescriptionText left={true}>
                  ...
                  pessoas sobre a importância da oração, através das reuniões de
                  oração todos os dias da semana (segunda à sexta), de 7h às 8h.
                </MinistryDescriptionText>
              </MinistryDescription>
            </MinistryInfo>
          </Ministry>
          <Ministry>
            ...
            <MinistryInfo>
              <MinistryDescription>
                <MinistryDescriptionText left={false}>
                  É um ministério que tem como finalidade servir a Jesus através
                  da evangelização e ajuda física (alimentos e roupas) aos
                  moradores em situação de rua do bairro e redondeza.
                  Quinzenalmente levamos alimentos a estes futuros irmãos,
                  resgatando dependentes químicos e os internando em centros de
                  recuperação para os ressocializar.
                </MinistryDescriptionText>
              </MinistryDescription>
          ...
          <Ministry>
            ...
            <MinistryInfo>
              ...
              <MinistryDescription>
                <MinistryDescriptionText left={true}>
                  Seu propósito é socorrer os que passam por dificuldades, seja
                  com um remédio, uma cesta básica ou outra coisa. Toda a Igreja
                  colabora para juntos ajudarmos quem está precisando.
                </MinistryDescriptionText>
              </MinistryDescription>
            </MinistryInfo>
          </Ministry>
            ...
            <MinistryInfo>
              ...
              <MinistryDescription>
                <MinistryDescriptionText left={true}>
                  ...
                  como objetivo secundário o desenvolvimento de ferramentas que
                  permitam uma melhor e maior integração da membresia da Igreja,
                  independente do grupo ao qual pertença. Contato:
            ...
            <MinistryInfo>
              <MinistryDescription>
                <MinistryDescriptionText left={false}>
                  ...
                  se desviaram. Esse ministério também é responsável pela classe
            ...
            <MinistryInfo>
              ...
              <MinistryDescription>
                <MinistryDescriptionText left={true}>
                  ...
                  missionários que tragam para a Igreja a realidade missionária
                  e a necessidade de nos envolvermos na obra.
                </MinistryDescriptionText>
              </MinistryDescription>
            </MinistryInfo>
          </Ministry>
          <Ministry>
            ...
            <MinistryInfo>
              <MinistryDescription>
                <MinistryDescriptionText left={false}>
                  É responsável em levar à Igreja até Deus em oração. Intercede
                  pelos cultos e pelos membros, pelos ministérios e seus
            ...
            <MinistryInfo>
              <MinistryDescription>
                <MinistryDescriptionText left={false}>
                  ...
                  Palavra. Toda última quarta-feira do mês, há um culto só para
                  as mulheres.
                </MinistryDescriptionText>
              </MinistryDescription>
              <MinistryLogo src="images/logo_default.jpeg" />
            ...
            <MinistryInfo>
              ...
              <MinistryDescription>
                <MinistryDescriptionText left={true}>
                  ...
                  Deus, para que elas ponham sua confiança no Senhor e obedeçam
                  a seus mandamentos. Buscamos criar oportunidades para semear
                  no coração das crianças de forma que elas possam crescer e
                  frutificar através dos encontros dominicais e dos eventos
                  intencionais durante o ano. Nossa equipe se reúne todos os
                  primeiros domingos de cada mês para orar, planejar e
                  consolidar ações importantes. Com as crianças de 0 a 11 anos,
                  nos reunimos todos os domingos de manhã, atualmente em classe
                  única, e à noite atuando por faixa etária: Berçário: 0 a 23
                  meses; Maternal: 2 a 3 anos; Infantil I: 4 a 5 anos; Infantil
                  II: 6 a 8 anos; Juniores: 9 a 11 anos.
                </MinistryDescriptionText>
              </MinistryDescription>
            </MinistryInfo>
          </Ministry>
          <Ministry>
            ...
            <MinistryInfo>
              <MinistryDescription>
                <MinistryDescriptionText left={false}>
                  Sua finalidade é ensinar às crianças o evangelho, abordando as
                  questões mais significativas. É um preparo para serem
            ...
            <MinistryInfo>
              ...
              <MinistryDescription>
                <MinistryDescriptionText left={true}>
                  ...
                  vida física, mental, social e espiritual. O propósito é servir
                  a Deus, promovendo comunhão, integração, ação social e
                  evangelização, além de criar oportunidades de melhoria na
                  renda familiar, por meio das oficinas de artesanato, promover
                  renovo espiritual ministrado pela palavra de Deus. Oficinas de
                  artesanato: Tricô - Crochê - Macramê - Biscuit - Vagonite -
                  Pintura em tecido – Bordado em pedras Oficinas de artesanato:
                  Tricô - Crochê - Macramê - Biscuit - Vagonite - Pintura em
                  tecido – Bordado em pedras
                </MinistryDescriptionText>
              </MinistryDescription>
            </MinistryInfo>
          </Ministry>
            ...
            <MinistryInfo>
              <MinistryDescription>
                <MinistryDescriptionText left={false}>
                  ...
                  missionária para meninos e rapazes de 9 a 17 anos (denominados
                  Embaixadores do Rei - ER), levando-os ao conhecimento bíblico,
                  organizacional e físico. Em nossa Igreja trabalhamos com a
                  faixa etária de 6 a 19 anos. A OER tem por finalidade cuidar
                  do ER no seu crescimento espiritual, físico e moral, ajudando
                  o ER a moldar o seu caráter espiritual e moral.
                </MinistryDescriptionText>
              </MinistryDescription>
          ...
          <Ministry>
            ...
            <MinistryInfo>
              ...
              <MinistryDescription>
                <MinistryDescriptionText left={true}>
                  É uma organização da denominação que trabalha com meninas de 9
                  a 17 anos. Ensina os princípios da Palavra e treina para que
                  cada menina seja uma líder.
                </MinistryDescriptionText>
              </MinistryDescription>
            </MinistryInfo>
          </Ministry>
          <Ministry>
            ...
            <MinistryInfo>
              <MinistryDescription>
                <MinistryDescriptionText>
                  Formar líderes para esse tempo. A Escola de Líderes é dividia
                  em seis módulos, cada um trata de uma área e visa um
                  discipulado voltado para a prática. Todos os membros precisam
            ...
            <MinistryInfo>
              ...
              <MinistryDescription>
                <MinistryDescriptionText left={false}>
                  ...
                  uma vez por mês o líder/discipulador irá se encontrar com seu
                  discípulo para orar, tirar dúvidas, ensinar, corrigir em amor
                  e acompanhar sua caminhada cristã.
                </MinistryDescriptionText>
              </MinistryDescription>
            </MinistryInfo>
          </Ministry>
            ...
            <MinistryInfo>
              ...
              <MinistryDescription>
                <MinistryDescriptionText left={true}>
                  ...
                  Além da questão esportiva, o objetivo é ensinar os princípios
                  da Palavra em uma sala ao lado da quadra de esportes. Em
                  breve.
                </MinistryDescriptionText>
              </MinistryDescription>
            </MinistryInfo>
